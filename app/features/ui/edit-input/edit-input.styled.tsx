...
export const SubTextSectionStyled = styled.section`
  display: flex;
  ...
  /* padding-inline: ${({ theme }) => theme?.spacing?.l}; */
`
SubTextSectionStyled.displayName = 'SubTextSectionStyled'
...
export const LengthStyled = styled.span`
  font-size: ${({ theme }) => theme?.fontSize?.s};
  font-weight: ${({ theme }) => theme?.fontWeight?.medium};
  color: ${({ theme }) => theme?.colors?.textC};
`
LengthStyled.displayName = 'LengthStyled'
